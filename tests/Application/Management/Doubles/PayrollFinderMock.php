...
class PayrollFinderMock implements \IteratorAggregate
{
	...
	{
		$this->files = array(
			new \SplFileInfo(vfsStream::url('root/payroll/test/01_nombre_(apellido1 apellido2, nombre1 nombre2)_empresa_22308_trabajador_130496_010216_mensual.pdf')),
			...
			new \SplFileInfo(vfsStream::url('root/payroll/test/03_nombre_(apellido1 apellido2, nombre1)_empresa_22308_trabajador_130296_010216_mensual.pdf'))
		);
	}
