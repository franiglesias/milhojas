...
class EventMessageTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$message = EventMessage::record(new EventDouble(1), new EntityVersionData('Entity', new Id(1), 1));
		$this->assertEquals('Tests\Library\EventSourcing\EventStore\Fixtures\EventDouble with Entity::1 (v. 1)', (string)$message);
	}
